...
exports.databaseQuery = (dbname) => {
    console.log(connection, dbname)
    return new Promise((resolve, reject) => {
        connection.query(`select c.table_name, c.column_name, c.ordinal_position,c.column_key,c.is_nullable, c.data_type, 
        ...
        `, dbname, function (error, results, fields){
            if(error)
                reject(error)
